...
## Env Wajib
`GEMINI_API_KEY` dari aistudio.google.com (Free), `GEMINI_MODEL=gemini-3.5-flash-lite`, `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `CRON_SECRET` (random 32 char), `ADMIN_USER`, `ADMIN_PASS`
